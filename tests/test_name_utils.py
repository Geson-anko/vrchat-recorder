...
from vrchat_recorder.name_utils import (
    ...
    get_vr_controller_event_log_file_name,
    get_vr_tracking_log_file_name,
    get_vrcrec_dir_name,
)
...
def test_get_vr_controller_event_log_file_name(date_str):
    expected_vr_controller_event_log_file_name = f"{date_str}.{FE.EVENT}.{FE.CONTROLLER}.{FE.CSV}"
    assert get_vr_controller_event_log_file_name(date_str) == expected_vr_controller_event_log_file_name


def test_get_vr_tracking_log_file_name(date_str):
    expected_vr_tracking_log_file_name = f"{date_str}.{FE.TRACKING}.{FE.BINARY}"
    assert get_vr_tracking_log_file_name(date_str) == expected_vr_tracking_log_file_name
